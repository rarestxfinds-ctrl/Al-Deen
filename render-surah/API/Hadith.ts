...
export async function getHadithCorpus() {
  ...
  try {
    // 🌟 1. __dirname is: /workspaces/ios-joyful-revamp/render-surah/API
    // 🌟 2. ".." moves up to: /workspaces/ios-joyful-revamp/render-surah
    // 🌟 3. Enters "Corpus/HadithCorpus.json"
    const filePath = path.resolve(__dirname, "..", "Corpus", "HadithCorpus.json");
