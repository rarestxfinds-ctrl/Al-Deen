        ...
        <Link to={continueReadingUrl} className="flex-1 min-w-[200px]">
          <Card className="p-4 sm:p-5 w-full hover:scale-[1.02] group h-full">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-sm font-medium group-hover:text-white dark:group-hover:text-black">
                Continue Reading
              </h2>
            ...
            <div className="flex items-center gap-3">
              <div
                className="font-surah text-3xl sm:text-4xl group-hover:text-white dark:group-hover:text-black"
                dir="rtl"
              >
            ...
            <div key={idx}>
              ...
              >
                <Card className="p-4 text-center transition-all hover:scale-[1.02] group">
                  <p className="font-semibold text-lg group-hover:text-white dark:group-hover:text-black">
                    {idx + 1}
                  </p>
                  <p
                    className="font-surah text-sm truncate group-hover:text-white dark:group-hover:text-black"
                    dir="rtl"
                  >
                    {word.text}
                  </p>
                  {word.translation && (
                    <p className="text-xs mt-1 truncate group-hover:text-white dark:group-hover:text-black">
                      {word.translation}
                    </p>
                  )}
                </Card>
              ...
              <Card className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 transition-all duration-200 group hover:scale-[1.02]">
                ...
                <div className="text-right flex-shrink-0">
                  <div className="flex items-center justify-end gap-1.5">
                    <span className="text-[10px] sm:text-xs text-muted-foreground group-hover:text-white/80 dark:group-hover:text-black/80">
                      {surah.revelationType === "Meccan" ? "Meccan" : "Medinan"}
                    </span>
                    <p
                      className="font-surah text-base sm:text-lg group-hover:text-white dark:group-hover:text-black"
                      dir="rtl"
                    >
                      {surah.surahFontName}
                    </p>
